...
export const ErrorState: React.FC<Props> = ({ message, onRetry }) => {
  return (
    <div className="w-full max-w-xl mx-auto my-12 p-8 rounded-3xl glass-royal border border-rose-500/30 text-center flex flex-col items-center justify-center">
